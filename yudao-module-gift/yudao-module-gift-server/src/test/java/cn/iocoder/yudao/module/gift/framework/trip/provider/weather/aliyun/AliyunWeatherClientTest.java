...
class AliyunWeatherClientTest {
    ...
    void setUp() {
        ...
        TripProviderProperties.Weather config = new TripProviderProperties.Weather()
    ...
    void testGetCurrentWeather_appCodeMissing() {
        client = new AliyunWeatherClient(new RestTemplate(), new TripProviderProperties.Weather().setAppCode(""));
