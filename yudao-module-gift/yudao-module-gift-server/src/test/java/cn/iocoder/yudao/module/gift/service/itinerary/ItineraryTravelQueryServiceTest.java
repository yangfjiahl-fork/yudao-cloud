...
class ItineraryTravelQueryServiceTest extends BaseMockitoUnitTest {

    @Mock
    private TravelPlaceQueryClientFacade travelPlaceQueryClientFacade;
    @InjectMocks
    private ItineraryTravelQueryService service;
    ...
    void getPlaceDetailConvertsProviderPlace() {
        ...
        ItineraryTravelQueryService.Place place = service.getPlaceDetail("poi-1");
