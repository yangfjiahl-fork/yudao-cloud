package cn.iocoder.yudao.module.gift.service.itinerary.provider.weather.aliyun;

import cn.iocoder.yudao.module.gift.service.itinerary.provider.config.ItineraryProviderProperties;
...
class AliyunWeatherClientTest {
    ...
    void setUp() {
        ...
        ItineraryProviderProperties.Weather config = new ItineraryProviderProperties.Weather()
    ...
    void testGetCurrentWeather_appCodeMissing() {
        client = new AliyunWeatherClient(new RestTemplate(), new ItineraryProviderProperties.Weather().setAppCode(""));
