...
public interface ItineraryMapper extends BaseMapperX<ItineraryDO> {
    ...
    default PageResult<ItineraryDO> selectPage(ItineraryPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<ItineraryDO>()
                ...
                .eqIfPresent(ItineraryDO::getFirstCoverUrl, reqVO.getFirstCoverUrl())
                .eqIfPresent(ItineraryDO::getFirstCoverHeight, reqVO.getFirstCoverHeight())
                .eqIfPresent(ItineraryDO::getFirstCoverWidth, reqVO.getFirstCoverWidth())
