...
@Data
public class ItineraryAgentEvent {
    ...
    public static ItineraryAgentEvent of(String event, String stage, String content) {
        return new ItineraryAgentEvent().setEvent(event).setStage(stage).setContent(content);
    }
