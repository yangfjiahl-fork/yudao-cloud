...
@Schema(description = "用户行程分页项 Response VO")
@Data
public class UserItineraryPageRespVO {
    ...
    @Schema(description = "会员编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "288")
