package cn.iocoder.yudao.module.gift.service.itinerary.provider.scenic;
...
public class ScenicSpotQueryClientFacade {
    ...
    public String provider() {
        try {
            return configApi.getConfigValueByKey(QUERY_FROM_CONFIG_KEY).getCheckedData();
        } catch (RuntimeException ex) {
            log.error("[provider][读取景点查询来源配置失败，key({})]", QUERY_FROM_CONFIG_KEY, ex);
            throw ex;
        }
    }
