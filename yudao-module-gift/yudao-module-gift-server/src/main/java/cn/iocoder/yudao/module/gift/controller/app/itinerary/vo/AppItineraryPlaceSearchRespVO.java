...
@Data
public class AppItineraryPlaceSearchRespVO {
    ...
    public static AppItineraryPlaceSearchRespVO from(ItineraryLocationService.PlaceSearchResult result,
                                                      Integer pageNo, Integer pageSize) {
        return new AppItineraryPlaceSearchRespVO().setCoordinateSystem("GCJ-02").setTotal(result.total())
    ...
    public static class Place {
        ...
        private static Place from(ItineraryLocationService.Place source) {
